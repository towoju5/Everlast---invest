                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @forelse ($deposits as $k => $item)
                                        <tr onclick="window.location.href='{{route('admin.withdrawal.show', $item->id)}}'" style="cursor: pointer">
                                            <td>{{ $k + 1 }}</td>
                                            ...
                                            <td>
                                                @if ($item->status == 0)
                                                    <a href="{{ route('admin.withdrawal.status', [$item->id, 'cancel']) }}">
                                                        <button class="btn btn-sm btn-danger">Cancel</button>
                                                    </a>
                                                    <a href="{{ route('admin.withdrawal.status', [$item->id, 'approve']) }}">
